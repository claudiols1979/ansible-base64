...
def run_module():
    ...
    if encode_status:
        ...
        result['message'] = "You data has been encoded to base 64."
        result['changed'] = True
    ...
    if decode_status:
        ...
        base64_decoded_bytes_string = str(base64.b64decode(base64_byte))

        result['original_message'] = base64_message
        result['decoded_message'] = base64_decoded_bytes_string
        result['message'] = "You data has been decoded to base 64."
        result['changed'] = True
